    ...
    >
      ...
      <SidebarContent>
        <Menu iconShape='circle'>
          ...
          >
            <NavLink exact to='/admin/challenges'>
              Challenges
            </NavLink>
          </MenuItem>
          ...
          >
            <NavLink exact to='/admin/evaluationStatus'>
              Evaluation Status
            </NavLink>
          </MenuItem>
          <MenuItem
          ...
          >
            <NavLink exact to='/admin/evaluationProcess'>
              Evaluation Config
            </NavLink>
          </MenuItem>
          <MenuItem
          ...
          >
            <NavLink exact to='/admin/registered-schools'>
              Institutions
            </NavLink>
          </MenuItem>
          <MenuItem
          ...
          >
            <NavLink exact to='/admin/userlist'>
              Users
            </NavLink>
          </MenuItem>
          <MenuItem
          ...
          >
            <NavLink exact to='/admin/tickets'>
              Support
            </NavLink>
          </MenuItem>
          ...
          >
            <NavLink exact to='/admin/translation'>
              Tranlsation
            </NavLink>
          </MenuItem>
          ...
          >
            <NavLink exact to='/admin/my-profile'>
              My Profile
            </NavLink>
          </MenuItem>
          ...
          >
            <NavLink exact onClick={handleLogout} to=''>
              Logout
            </NavLink>
          </MenuItem>
        </Menu>
