    ...
    >
      ...
      <SidebarContent>
        <Menu iconShape="circle">
          ...
          <MenuItem
            icon={<img src={ChallengesIcon} style={{ width: "20px" }} />}
            className={
          ...
          >
            ...
            >
              <span style={{ color: "var(--override-color)" }}>Challenges</span>
            </NavLink>
          </MenuItem>

          <MenuItem
            icon={<img src={EvaluationIcon} style={{ width: "20px" }} />}
            className={
              (location.pathname === "/admin/evaluationStatus" ||
                location.pathname === "/admin/evaluationStatus/viewlist") &&
              "sidebar-active"
            }
          >
            <NavLink
          ...
          <MenuItem
            icon={<img src={EvalConifIcon} style={{ width: "20px" }} />}
            className={
          ...
          <MenuItem
            ...
            className={
              (location.pathname === "/admin/registered-schools" ||
                location.pathname === "/admin/register-new-schools") &&
              "sidebar-active"
            }
          >
            <NavLink
          ...
          <MenuItem
            icon={<img src={ResourceIcon} style={{ width: "20px" }} />}
            className={
              location.pathname === "/admin/Resources/index" && "sidebar-active"
            }
          >
            <NavLink
              exact={true}
            ...
            >
              <span style={{ color: "var(--override-color)" }}>Resources</span>
            </NavLink>
          </MenuItem>
          <MenuItem
            icon={<img src={PopupIcon} style={{ width: "20px" }} />}
            className={location.pathname === "/admin/popup" && "sidebar-active"}
          >
            <NavLink
              exact={true}
              to={"/admin/popup"}
            ...
            >
              <span style={{ color: "var(--override-color)" }}>PopUp</span>
            </NavLink>
          </MenuItem>
          <MenuItem
            icon={
          ...
          >
            ...
            >
              <span style={{ color: "var(--override-color)" }}>LatestNews</span>
            </NavLink>
          </MenuItem>
          <MenuItem
            icon={<img src={UsersIcon1} style={{ width: "20px" }} />}
            className={
          ...
          >
            ...
            >
              <span style={{ color: "var(--override-color)" }}>Users</span>
            </NavLink>
          </MenuItem>
          <MenuItem
            icon={<img src={BadgesIcon} style={{ width: "20px" }} />}
            className={
          ...
          >
            ...
            >
              <span style={{ color: "var(--override-color)" }}>Badges</span>
            </NavLink>
          </MenuItem>
          ...
          >
            ...
            >
              <span style={{ color: "var(--override-color)" }}>FAQs</span>
            </NavLink>
          </MenuItem>
          ...
          >
            ...
            >
              <span style={{ color: "var(--override-color)" }}>Support</span>
            </NavLink>
          </MenuItem>
          ...
          <MenuItem
            ...
            className={
              location.pathname === "/admin/translation" && "sidebar-active"
            }
          >
            <NavLink
              exact={true}
          ...
          >
            ...
            >
              <span style={{ color: "var(--override-color)" }}>Reports</span>
            </NavLink>
          </MenuItem>
          ...
          <MenuItem
            ...
            className={
              location.pathname === "/admin/my-profile" && "sidebar-active"
            }
          >
            <NavLink
              exact={true}
            ...
            >
              <span style={{ color: "var(--override-color)" }}>My Profile</span>
            </NavLink>
          </MenuItem>
