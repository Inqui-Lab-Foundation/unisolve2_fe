...
const DetaledQuiz = (props) => {
  ...
  const isQuizCompleted = totalQuestions === props.adminCourseQst.count;
          ...
          <Fragment>
            <div className="question-section">
              {isQuizCompleted ? (
                ...
                <div className="score">{t('student.score')}: {correctAnswers/2}/{totalQuestions}</div>
              )}
              <Row>
                <Col xs={10}>
