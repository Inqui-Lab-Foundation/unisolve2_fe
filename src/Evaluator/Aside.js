    ...
    >
      ...
      <SidebarContent>
        <Menu iconShape='circle'>
          ...
          >
            <NavLink exact to='/evaluator/instructions'>
              Instructions
            </NavLink>
          </MenuItem>
          <MenuItem
          ...
          >
            <NavLink exact to='/evaluator/submitted-ideas'>
              Evaluation
            </NavLink>
          </MenuItem>
          <MenuItem
          ...
          >
            <NavLink exact to='/evaluator/evaluated-ideas'>
              Evaluated Ideas
            </NavLink>
          </MenuItem>
          <MenuItem
          ...
          >
            <NavLink exact to='/evaluator/change-password'>
              Change Password
            </NavLink>
          </MenuItem>
          <MenuItem
