    ...
    >
      ...
      <SidebarContent>
        <Menu iconShape='circle'>
          ...
          >
            <NavLink exact to='/student/pre-survey'>
              {/* Pre Survey */}
              {t('home.pre_survey')}
            </NavLink>
          </MenuItem>
          ...
          >
            <NavLink exact onClick={handleClick} to='/dashboard'>
              {/* Dashboard */}
              {t('home.dashboard')}
            </NavLink>
          </MenuItem>
          ...
          >
            <NavLink exact onClick={handleClick} to='/badges'>
              {t('home.badges')}
            </NavLink>
          </MenuItem>
          <MenuItem
          ...
          >
            <NavLink exact onClick={handleClick} to='/challenges'>
          ...
          >
            <NavLink exact onClick={handleClick} to='/faq'>
              {/* FAQ */}
              {t('home.faq')}
            </NavLink>
          </MenuItem>
